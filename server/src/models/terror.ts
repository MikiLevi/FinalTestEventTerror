...
export const TerrorSchema: Schema = new Schema({
  eventid: { type: Number, required: true },
  iyear: { type: Number, required: true },
  imonth: { type: Number, required: false },
  iday: { type: Number, required: false },
  ...
  weaptype1_txt: { type: String, required: false },
  nkill: { type: Number, required: false },
  nwound: { type: Number, required: false },
  ransomamt: { type: Number, required: false },
