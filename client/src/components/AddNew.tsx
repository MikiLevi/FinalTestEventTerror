...
import { addEvent } from "../service/DataService";
import { IEvent } from "../interface/Eevent";

const AddEvent: FC = () => {
  const [Terror, setTerrorEvent] = useState<Partial<IEvent>>({
    eventid: 0,
    iyear: 2024,
    imonth: 1,
    iday: 1,
    ...
    nwound: 0,
    summary:
      "A tragic terror attack unfolded today, claiming innocent lives and leaving many injured. Authorities are investigating, urging unity and resilience.",
  });
